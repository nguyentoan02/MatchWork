                        ...
                        <div className="text-center py-8 text-muted-foreground">
                            ...
                            {canManage && (
                                <p className="text-sm mt-2">
                                    Nhấn "Gắn bài tập tự luận mới" để thêm SAQ.
                                </p>
                            )}
                        </div>
                    ) : (
                                            ...
                                            <div className="space-y-3">
                                                ...
                                                <div className="pt-3 border-t border-border">
                                                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                                                        ...
                                                        {!canManage && quizAttempts?.submissionIds && (
                                                            <div className="flex items-center gap-2">
                                                                {quizAttempts.submissionIds.length > 0 ? (
                                                                    <>
                                                                        ...
                                                                        <Button
                                                                            ...
                                                                            onClick={() => {
                                                                                const latestId = quizAttempts.submissionIds[quizAttempts.submissionIds.length - 1];
                                                                                navigate(`/student/doneSAQ?quizId=${latestId}`);
                                                                            }}
                                                                        >
                                                                            ...
                                                                            <PopoverTrigger asChild>
                                                                                ...
                                                                                >
                                                                                    <span className="text-xs font-medium">
                                                                                        {quizAttempts.submissionIds.length} lần
                                                                                    </span>
                                                                                </Button>
                                                                            </PopoverTrigger>
                                                                            <PopoverContent className="w-56">
                                                                                <div className="space-y-2">
                                                                                    <div className="flex items-center justify-between">
                                                                                        <h4 className="font-medium text-sm">Tất cả lần làm bài</h4>
                                                                                        <Badge variant="secondary" className="text-xs">
                                                                                            {quizAttempts.submissionIds.length}
                                                                                        </Badge>
                                                                                    </div>
                                                                                    <Separator />
                                                                                    <div className="max-h-60 overflow-y-auto space-y-1">
                                                                                        {quizAttempts.submissionIds.map((submissionId, attemptIndex) => {
                                                                                            const isLatest = attemptIndex === quizAttempts.submissionIds.length - 1;
                                                                                            return (
                                                                                                <Button
                                                                                                    key={submissionId}
                                                                                                    variant="ghost"
                                                                                                    size="sm"
                                                                                                    className={`w-full justify-between text-xs h-8 ${isLatest ? 'bg-blue-50' : ''}`}
                                                                                                    onClick={() => {
                                                                                                        navigate(`/student/doneSAQ?quizId=${submissionId}`);
                                                                                                    }}
                                                                                                >

...
export function TutorHeader({ tutor }: TutorHeaderProps) {
   ...
   // Mutation để tạo conversation cho nhắn tin
                  ...
                  <div className="flex flex-col items-center lg:items-start">
                     ...
                     <div className="mt-4 text-center lg:text-left">
                        ...
                        <p className="text-sm text-gray-600 font-medium">
                           {tutor.ratings?.average?.toFixed(1) ?? "0.0"} •{" "}
                           {tutor.ratings?.totalReviews ?? 0} đánh giá
                        </p>
                     </div>
                  </div>
                  ...
                  <div className="flex-1 space-y-6">
                     ...
                     <div className="flex flex-wrap gap-3 pt-2">
                        ...
                        <Button
                           ...
                           className="bg-gray-100 hover:bg-gray-200 text-gray-900 border-0 disabled:bg-gray-400 disabled:cursor-not-allowed"
                        ...
                        >
                           ...
                           {isFullyBooked ? "Hết chỗ" : "Đặt lịch học"}
                        </Button>
                     </div>
                  </div>
               </div>

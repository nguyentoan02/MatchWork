...
import { useSessionAssignedShortAnswerQuizzes } from "@/hooks/useSAQ"; // This now uses the new hook
import { useDeleteShortAnswerQuiz } from "@/hooks/useSAQ";
import {
    Calendar,
    Users,
    Clock,
...
interface DeleteShortAnswerQuizModalProps {
    quizId: string;
    isOpen: boolean;
    onClose: () => void;
    quizTitle?: string;
...
const DeleteShortAnswerQuizModal: React.FC<DeleteShortAnswerQuizModalProps> = ({
    quizId,
    isOpen,
    onClose,
    quizTitle,
}) => {
    const { data, isLoading, isError } = useSessionAssignedShortAnswerQuizzes(quizId);
    const deleteQuiz = useDeleteShortAnswerQuiz();
                ...
                <DialogContent className="max-w-4xl max-h-[80vh] flex flex-col">
                    <DialogHeader>
                        <DialogTitle className="flex items-center gap-2">
                            ...
                            Xác nhận xóa Short Answer Quiz
                        </DialogTitle>
                        <DialogDescription>
                            {quizTitle && (
                            ...
                            <div className="flex items-start gap-3 p-4 bg-yellow-50 dark:bg-yellow-950/20 border border-yellow-200 dark:border-yellow-800 rounded-lg">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-yellow-700 dark:text-yellow-300">
                                        Short Answer Quiz này đang được sử dụng trong {sessions.length}{" "}
                    ...
                    <div className="flex items-center justify-between pt-4 border-t">
                        <div className="flex items-center gap-2 text-sm text-muted-foreground">
                            ...
                            {hasAssignedSessions
                                ...
                                : "Bạn có chắc chắn muốn xóa short answer quiz này?"}
                        </div>
...
export default DeleteShortAnswerQuizModal;
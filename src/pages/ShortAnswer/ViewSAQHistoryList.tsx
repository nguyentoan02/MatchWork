            ...
            {submissionHistory.map((submission: any) => {
               ...
               const totalPossiblePoints = submission.answers.reduce(
                  (sum: number, answer: any) =>
                     sum + (answer.questionId?.points || 0),
                  0
               );
                  ...
                  >
                        ...
                        <div className="flex items-center justify-between">
                           <CardTitle className="flex items-center gap-2">
                              ...
                              <div className="flex flex-col">
                                 <span>
                                    {submission.quizId?.title || "Bài tự luận"}
                                 </span>
                     ...
                     <CardContent className="space-y-4">
                        ...
                        <div className="flex flex-wrap items-center gap-4 text-sm text-muted-foreground">
                           ...
                           >
                              {getQuestionTypeLabelVi(
                                 submission.quizId?.quizType || "SHORT_ANSWER"
                              )}
                           </Badge>
                        </div>
                        ...
                        <div className="flex items-center justify-between pt-2 border-t">
                           ...
                           <div className="flex gap-2">
                              <Button
                                 ...
                                 onClick={() => {
                                    navigate(
                                       `/student/doneSAQ?quizId=${submission._id}`
                                    );
                                 }}
                              >
                              ...
                              <Button
                                 ...
                                 onClick={() => {
                                    if (submission.quizId?._id) {
                                       navigate(
                                          `/student/doSAQ?shortAnswerId=${submission.quizId._id}`
                                       );
                                    }
                                 }}
                              >

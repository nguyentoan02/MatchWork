...
import { CheckIcon, StarIcon, TrendingUpIcon, CrownIcon, Loader2 } from 'lucide-react';
...
export default function PricingPage() {
  ...
  const pricingTiers: PricingTier[] = React.useMemo(() => {
    ...
    return packages.map((pkg, index) => ({
      ...pkg,
      highlighted: pkg.popular || false, // Mark as highlighted based on popular field
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Chọn gói dịch vụ phù hợp với nhu cầu của bạn và bắt đầu hành trình
          ...
          <div className="flex justify-center gap-8">
            {pricingTiers.map((tier) => (
              ...
              >
                ...
                {/* Icon */}
                <div className={`mb-4 ${tier.highlighted ? 'text-white' : 'text-indigo-600'}`}>
                  {tier.icon}
                </div>
                ...
                {/* Description - not in API, so we'll skip or use first feature as description */}
                ...
                <ul className="space-y-3 mb-8">
                  {tier.description?.map((feature, featureIndex) => (
                    <li key={featureIndex} className="flex items-start">
                      ...
                      />
                      <span
                        className={tier.highlighted ? 'text-indigo-50' : 'text-gray-700'}
                      >
                        {feature}
                      </span>
                    </li>
                  ...
                  {/* Add features from features object if available */}
